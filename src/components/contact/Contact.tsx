      ...
      <div className="contact-card contact-animate">
        ...
        <div className="contact-intro">
          <div className="contact-intro__text">
            <h2 className="contact-intro__title">Let&apos;s Collaborate</h2>
            <p className="contact-intro__desc">
              Open to <strong>AI-driven</strong> projects, research collaborations, and consulting.
            </p>
          </div>
          ...
          <div className="contact-intro__actions">
            ...
            <div className="contact-intro__secondary">
              <a href="mailto:ansanchezdev@gmail.com" className="contact-btn contact-btn--ghost">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">

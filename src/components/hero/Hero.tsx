      ...
      <div className="hero__content relative z-10 mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-6 text-center">
        ...
        <nav className="navbar fixed top-0 left-0 right-0 z-50 px-6 py-6 lg:px-12">
          <div className="mx-auto flex max-w-7xl items-center justify-between">
            ...
            <a
              ...
              className="cv-button hidden md:inline-block rounded-md bg-white px-5 py-2 text-sm font-medium text-[#05040A] transition-all duration-300 hover:bg-[#f0f0f0] hover:-translate-y-0.5"
            >
              View CV
            </a>
        ...
        <div className={`mobile-menu ${menuOpen ? 'open' : ''}`}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-hero mobile-menu__cv rounded-lg"
        ...
        {/* Hero Content */}
        <div className="hero-inner flex flex-col items-center mb-[15%] md:mb-[30%]">
        ...
        <div className="absolute bottom-[12%] md:bottom-[28%] left-0 right-0 z-20">
          <LogoCarousel />
        </div>
      </div>
    </section>
